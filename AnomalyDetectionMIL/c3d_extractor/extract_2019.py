...
For example, "python {} {}" will extract features from an example image.'''.format(
    ...
    tmp_dir = '/tmp/c3d_feature_2019'
    # make a empty folder to save files
    ...
    max_processing_sec = 599  # 599 previous
    ...
    # set start frames
    start_frames = []
    total_to_extract = min(num_frames, max_processing_sec * sample_every_N_sec)
    for i in range(int(total_to_extract/16)):
        start_frames.append(i*16)
    '''
